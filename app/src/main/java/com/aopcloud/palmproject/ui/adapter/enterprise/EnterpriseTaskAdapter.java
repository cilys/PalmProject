 ...
 * @File : EnterpriseTaskAdapter.java
 ...
 * @Describe ：
 */
public class EnterpriseTaskAdapter extends BaseQuickAdapter<ProjectTaskBean, BaseViewHolder> {
    public EnterpriseTaskAdapter(int layoutResId, @Nullable List<ProjectTaskBean> data) {
    ...
    protected void convert(BaseViewHolder helper, ProjectTaskBean item) {
        ...
        helper.setText(R.id.tv_title, item.getName())
                ...
                .setVisible(R.id.tv_project_time_count,item.getStatus_str().equals("已逾期")||item.getStatus_str().equals("进行中")||item.getStatus_str().equals("作业中"))
