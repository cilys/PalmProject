...
public class ProjectLeaderListActivity extends BaseAc implements
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        if (view.getId() == R.id.tv_del) {
            ...
            ProjectMemberBean.UsersBean usersBean = (ProjectMemberBean.UsersBean) mBeanList.get(position);
            JumpActionUtil.jump2CallPhone(ProjectLeaderListActivity.this, usersBean.getTel() + "");
        } else if (view.getId() == R.id.iv_send_sms) {
            ProjectMemberBean.UsersBean usersBean = (ProjectMemberBean.UsersBean) mBeanList.get(position);
            JumpActionUtil.jump2SendSms(ProjectLeaderListActivity.this, usersBean.getTel() + "");
        }
    }
    ...
    private void showTips() {
        ...
        dialog.setContentView(R.layout.dialog_project_leader_tips);
