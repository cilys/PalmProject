 ...
 * @Describe ：
 */
public class TaskManagerAdapter extends BaseQuickAdapter<ProjectTaskBean, BaseViewHolder> {
    public TaskManagerAdapter(int layoutResId, @Nullable List<ProjectTaskBean> data) {
