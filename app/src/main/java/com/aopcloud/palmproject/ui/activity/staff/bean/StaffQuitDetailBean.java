 ...
 * @Describe ：
 */
public class StaffQuitDetailBean {
    ...
    private StaffSDetailBean.CompanyBean company;
    private List<StaffSDetailBean.RoleTagsBean> roleTags;
    private List<StaffSDetailBean.TrendsBean> trends;
    ...
    public StaffSDetailBean.CompanyBean getCompany() {
        return company;
    }

    public void setCompany(StaffSDetailBean.CompanyBean company) {
        this.company = company;
    }

    public List<StaffSDetailBean.RoleTagsBean> getRoleTags() {
        return roleTags;
    }

    public void setRoleTags(List<StaffSDetailBean.RoleTagsBean> roleTags) {
        this.roleTags = roleTags;
    }

    public List<StaffSDetailBean.TrendsBean> getTrends() {
        return trends;
    }

    public void setTrends(List<StaffSDetailBean.TrendsBean> trends) {
        this.trends = trends;
    }
