...
public class TeamAddMemberActivity extends BaseAc {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_submit:
              String  selectedItem = (String) mSpinnerType.getSelectedItem();
                ...
                toRequest( ApiConstants.EventTags.teammember_add);
                break;
        }
    }
    ...
    public void toRequest(int eventTag) {
        ...
        if (eventTag == ApiConstants.EventTags.teammember_add) {
            map.put("user_id", "" + user_id);
            map.put("majors", "" + majors);
            map.put("salary", "" + salary);
            map.put("type", "" + type);
            iCommonRequestPresenter.requestPost(eventTag, this, ApiConstants.teammember_add, map);
        }
    }
