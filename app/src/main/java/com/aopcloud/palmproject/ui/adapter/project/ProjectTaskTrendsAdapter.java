 ...
 * @File : ProjectTaskTrendsAdapter.java
 ...
 * @Describe ：
 */
public class ProjectTaskTrendsAdapter extends BaseQuickAdapter<ProjectTaskDetailBean.TrendsBean, BaseViewHolder> {
    public ProjectTaskTrendsAdapter(int layoutResId, @Nullable List<ProjectTaskDetailBean.TrendsBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ProjectTaskDetailBean.TrendsBean item) {
