 ...
 * @Describe ：
 */
@Layout(R.layout.activity_project_progress_update)
public class UpdateProjectProgressActivity extends BaseActivity implements FileListAdapter.OnItemChildClickListener,
    ...
    protected void initData() {
        ...
        if (bundle != null) {
            ...
            last_time=  bundle.getLong("last_time",0);
        }
    ...
    protected void initView() {
        ...
        if (last_time!=0){
            ...
            Date date = new Date();
            date.setTime(last_time*1000);
            mTvLastTime.setText(""+dateFormat.format(date));
        }else {
            mTvLastTime.setText("");
        }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        if (position == mMediaEntities.size() - 1) {
            ...
            Phoenix.with()
                    ...
                    .start(UpdateProjectProgressActivity.this, PhoenixOption.TYPE_PICK_MEDIA, 2);
        } else {
