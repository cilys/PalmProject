package com.aopcloud.palmproject.player;
...
/**
 * @PackageName : com.aopcloud.palmproject.player
 * @File : PreviewPlayerController.java
 ...
 * @Describe ：
 */
public class PreviewPlayerController extends AbsVideoPlayerController implements View.OnClickListener{
    ...
    public PreviewPlayerController(Context context) {
        super(context);
        mContext = context;
        init();
    }
     ...
     */
    private void init() {
        LayoutInflater.from(mContext).inflate(org.yczbj.ycvideoplayerlib.R.layout.custom_video_player, this, true);
        initFindViewById();
        initListener();
    ...
    private void initFindViewById() {
        mCenterStart = findViewById(org.yczbj.ycvideoplayerlib.R.id.center_start);
        mImage = findViewById(org.yczbj.ycvideoplayerlib.R.id.image);
        mImage.setScaleType(ImageView.ScaleType.FIT_CENTER);

        mTop = findViewById(org.yczbj.ycvideoplayerlib.R.id.top);
        mBack = findViewById(org.yczbj.ycvideoplayerlib.R.id.back);
        mBack.setVisibility(GONE);
        mTop.setVisibility(GONE);
        mTitle = findViewById(org.yczbj.ycvideoplayerlib.R.id.title);
        mLlTopOther = findViewById(org.yczbj.ycvideoplayerlib.R.id.ll_top_other);
        mIvDownload = findViewById(org.yczbj.ycvideoplayerlib.R.id.iv_download);
        mIvAudio =  findViewById(org.yczbj.ycvideoplayerlib.R.id.iv_audio);
        mIvShare = findViewById(org.yczbj.ycvideoplayerlib.R.id.iv_share);
        mIvMenu = findViewById(org.yczbj.ycvideoplayerlib.R.id.iv_menu);

        mLlHorizontal = findViewById(org.yczbj.ycvideoplayerlib.R.id.ll_horizontal);
        mIvHorAudio = findViewById(org.yczbj.ycvideoplayerlib.R.id.iv_hor_audio);
        mIvHorTv = findViewById(org.yczbj.ycvideoplayerlib.R.id.iv_hor_tv);
        mBattery = findViewById(org.yczbj.ycvideoplayerlib.R.id.battery);
        mTime = findViewById(org.yczbj.ycvideoplayerlib.R.id.time);

        mBottom = findViewById(org.yczbj.ycvideoplayerlib.R.id.bottom);
        mRestartPause = findViewById(org.yczbj.ycvideoplayerlib.R.id.restart_or_pause);
        mPosition = findViewById(org.yczbj.ycvideoplayerlib.R.id.position);
        mDuration = findViewById(org.yczbj.ycvideoplayerlib.R.id.duration);
        mSeek = findViewById(org.yczbj.ycvideoplayerlib.R.id.seek);
        mFullScreen = findViewById(org.yczbj.ycvideoplayerlib.R.id.full_screen);
        mClarity = findViewById(org.yczbj.ycvideoplayerlib.R.id.clarity);
        mLength = findViewById(org.yczbj.ycvideoplayerlib.R.id.length);
        mLoading = findViewById(org.yczbj.ycvideoplayerlib.R.id.loading);
        pbLoadingRing = findViewById(org.yczbj.ycvideoplayerlib.R.id.pb_loading_ring);
        pbLoadingQq = findViewById(org.yczbj.ycvideoplayerlib.R.id.pb_loading_qq);

        mLoadText = findViewById(org.yczbj.ycvideoplayerlib.R.id.load_text);
        mChangePosition = findViewById(org.yczbj.ycvideoplayerlib.R.id.change_position);
        mChangePositionCurrent = findViewById(org.yczbj.ycvideoplayerlib.R.id.change_position_current);
        mChangePositionProgress = findViewById(org.yczbj.ycvideoplayerlib.R.id.change_position_progress);
        mChangeBrightness = findViewById(org.yczbj.ycvideoplayerlib.R.id.change_brightness);
        mChangeBrightnessProgress = findViewById(org.yczbj.ycvideoplayerlib.R.id.change_brightness_progress);
        mChangeVolume = findViewById(org.yczbj.ycvideoplayerlib.R.id.change_volume);
        mChangeVolumeProgress = findViewById(org.yczbj.ycvideoplayerlib.R.id.change_volume_progress);

        mError = findViewById(org.yczbj.ycvideoplayerlib.R.id.error);
        mTvError = findViewById(org.yczbj.ycvideoplayerlib.R.id.tv_error);
        mRetry = findViewById(org.yczbj.ycvideoplayerlib.R.id.retry);
        mCompleted = findViewById(org.yczbj.ycvideoplayerlib.R.id.completed);
        mReplay = findViewById(org.yczbj.ycvideoplayerlib.R.id.replay);
        mShare = findViewById(org.yczbj.ycvideoplayerlib.R.id.share);
        mFlLock = findViewById(org.yczbj.ycvideoplayerlib.R.id.fl_lock);
        mIvLock = findViewById(org.yczbj.ycvideoplayerlib.R.id.iv_lock);

        mLine = findViewById(org.yczbj.ycvideoplayerlib.R.id.line);
        mPbPlayBar = findViewById(org.yczbj.ycvideoplayerlib.R.id.pb_play_bar);
    ...
    public void setBackVisibility(int v) {
        mBack.setVisibility(v);
    }

    public void setCompletedShare(int v) {
        mShare.setVisibility(v);
    }

    public void setLengthVisibility(int v) {
        mLength.setVisibility(v);
    }
    ...
    public void setCenterPlayer(boolean isVisibility, @DrawableRes int image) {
        ...
        if(isVisibility){
            if(image==0){
                mCenterStart.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.ic_player_center_start);
            }else {
    ...
    public void onPlayModeChanged(int playMode) {
        switch (playMode) {
            ...
            case ConstantKeys.PlayMode.MODE_NORMAL:
                ...
                mFullScreen.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.ic_player_open);
            ...
            case ConstantKeys.PlayMode.MODE_FULL_SCREEN:
                ...
                mBack.setVisibility(View.VISIBLE);
                mFullScreen.setVisibility(View.VISIBLE);
                mFullScreen.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.ic_player_close);
                if (clarities != null && clarities.size() > 1) {
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            ...
            if (mVideoPlayer.isNormal() || mVideoPlayer.isTinyWindow()) {
                ...
                mIsLock = false;
                mIvLock.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.player_unlock_btn);
    ...
    public void onBatterStateChanged(@ConstantKeys.BatterMode int batterState) {
        switch (batterState){
            case ConstantKeys.BatterMode.BATTERY_10:
                mBattery.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.battery_10);
                break;
            case ConstantKeys.BatterMode.BATTERY_20:
                mBattery.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.battery_20);
                break;
            case ConstantKeys.BatterMode.BATTERY_50:
                mBattery.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.battery_50);
                break;
            case ConstantKeys.BatterMode.BATTERY_80:
                mBattery.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.battery_80);
                break;
            case ConstantKeys.BatterMode.BATTERY_100:
                mBattery.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.battery_100);
                break;
            case ConstantKeys.BatterMode.BATTERY_FULL:
                mBattery.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.battery_full);
                break;
            case ConstantKeys.BatterMode.BATTERY_CHARGING:
                mBattery.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.battery_charging);
                break;
            default:
                break;
        }
    ...
    private void setLock(boolean isLock){
        if(isLock){
            ...
            mIsLock = true;
            mIvLock.setImageResource(org.yczbj.ycvideoplayerlib.R.drawable.player_locked_btn);
        }
        /*
         * 设置锁屏时的布局
         * 1.横屏全屏时显示，其他不展示；
