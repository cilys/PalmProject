package com.aopcloud.palmproject.view.decoration;
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
  ...
  public   DividerItemDecoration() {
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent, int lineWidth, int lineHeight) {
        boolean isDrawDoubleLine = false;
        RecyclerView.LayoutManager layoutManager = parent.getLayoutManager();
        if (layoutManager instanceof StaggeredGridLayoutManager && ((StaggeredGridLayoutManager) layoutManager).getOrientation() == StaggeredGridLayoutManager.VERTICAL) {   // 绘制双线
            isDrawDoubleLine = true;
        }
        canvas.save();
        if (parent.getClipToPadding()) {
